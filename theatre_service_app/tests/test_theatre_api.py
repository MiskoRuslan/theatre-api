...
from theatre_service_app.models import Play, Performance, TheatreHall, Genre, Actor
from theatre_service_app.serializers import PlayDetailSerializer, PlayListSerializer
